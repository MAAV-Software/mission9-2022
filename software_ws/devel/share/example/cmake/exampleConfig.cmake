...
if("TRUE" STREQUAL "TRUE")
  set(example_SOURCE_PREFIX /mission9-2022/software_ws/src/example)
  set(example_DEVEL_PREFIX /mission9-2022/software_ws/devel)
  set(example_INSTALL_PREFIX "")
  set(example_PREFIX ${example_DEVEL_PREFIX})
else()
  set(example_SOURCE_PREFIX "")
  set(example_DEVEL_PREFIX "")
  set(example_INSTALL_PREFIX /mission9-2022/software_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'example' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/mission9-2022/software_ws/src/example/${idir}'.  ${_report}")
    endif()
...
set(depends "cv_bridge;image_transport;std_msgs")
